...
-->
<link href="<?php echo base_url('plugins/bootstrap/css/bootstrap.css') ?>" rel="stylesheet" type="text/css"/>
<link href="<?php echo base_url('plugins/font-awesome-4.0.3/css/font-awesome.min.css') ?>" rel="stylesheet"
      type="text/css"/>
