...
class Product_controller extends Controller
{
    ...
    public function index()
    {
        ...
        $crud->fields('name', 'slug', 'price', 'manufacturer', 'category', 'image', 'gallery', 'description', 'page_title', 'content_tag', 'city_id', 'author_id', 'status');
        ...
        $crud->set_relation_n_n('category', 'product_category', 'category', 'product_id', 'category_id', 'name');
    ...
    public function multiple_upload($value = '', $primary_key = null)
    {
